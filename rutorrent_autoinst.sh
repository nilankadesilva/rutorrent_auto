...
NGINX_NAME="nginx-1.8.1"
NGINX_URL="http://nginx.org/download/$NGINX_NAME.tar.gz"

LIGHTTPD_NAME="lighttpd-1.4.39"
...
resetPath() {
	PATH="/usr/local/sbin:/usr/bin:/usr/sbin:/usr/bin:/sbin:/bin:\$PATH"
}
resetPath
...
sessionName = 'autodl'
user = '$user'
path = '/usr/local/sbin:/usr/bin:/usr/sbin:/usr/bin:/sbin:/bin'
